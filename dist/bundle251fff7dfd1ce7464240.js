...
document.addEventListener('DOMContentLoaded', function () {
  ...
  function generateQuestion() {
    ...
    if (pendingQuestions.length > 0 && Math.random() > 0.5) {
      ...
      console.log("pending questions ".concat(pendingQuestions));
    ...
    var choices = [currentQuestion.correctDefinition];
  ...
  submitButton.addEventListener('click', function () {
    ...
    console.log(currentQuestion.word);
    checkAnswer("".concat(currentQuestion.name), "".concat(currentQuestion.correctDefinition));
  });
...
/******/ })()
;
//# sourceMappingURL=bundle251fff7dfd1ce7464240.js.map